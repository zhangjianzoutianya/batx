    ...
    <div class="index_pro">
      ...
      <div class="index_pro_box">
        <div class="item item1">
          ...
          <div class="writ_bot">
            <p><span>研发制造</span><span>智能管理</span><span>检测运维</span><span>寿命预测</span>       </p>
          </div>
          <div class="icon_png">
        ...
        <div class="item item2">
          ...
          <div class="writ_bot">
            <p><span>固态电池</span><span>电动汽车</span><span>储能电池</span><span>光伏电池</span>       </p>
          </div>
          <div class="icon_png">
            <img src="@/assets/img1/jiant.png" />
          </div>
...
@keyframes scroll-left {
  ...
  100% { transform: translateX(-50%); } /* 往左移动一半内容宽度 */
}

@keyframes scroll-right {
  0% { transform: translateX(-50%); }
  100% { transform: translateX(0); } /* 往右移回来 */
}
